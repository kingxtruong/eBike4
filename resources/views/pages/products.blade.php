...
<main id="main-products">
        <div class="path-page-wrapper">
            <div class="path-page">
                <a href="{{route('homepage')}}" >Trang chủ</a><h3 style="display: inline-block;"></h3><span><a href="{{route('products')}}">Tất cả sản phẩm</a></span>
            </div>
        </div>
                  ...
                  <div class="products-catogory">
                      ...
                      <div class="products-catogory-Search">
                          <form method="get" action="{{route('search-products')}}">
                              ...
                              Giá sản phẩm
                                <ul>
                                  <li><input type="radio" name="rad_price"  value="10000000" /><label>&lt; 10.000.000 đ</label></li>
                                  <li><input type="radio" name="rad_price"  value="15000000" /><label>&lt; 15.000.000 đ</label></li>
                                  <li><input type="radio" name="rad_price"  value="20000000" /><label>&lt; 20.000.000 đ</label></li> 
                                  <li><input type="radio" name="rad_price"  value="25000000" /><label>&lt; 25.000.000 đ</label></li>
                                  <li><input type="radio" name="rad_price"  value="30000000" /><label>&lt; 30.000.000 đ</label></li>                              
                                </ul>
                              </div>
                              ...
                              Tùy chọn khác
                                <ul>
                                  <li><input type="radio" name="rad_other" value="otherNew" /><label>New</label></li>
                                  <li><input type="radio" name="rad_other" value="otherSale" /><label>Sale</label></li>
                                  <li><input type="radio" name="rad_other" value="otherHot" /><label>Hot</label></li>
                                </ul>
                              </div>
