...
<main id="main-products">
        <div class="path-page-wrapper">
            <div class="path-page">
                <a href="{{route('homepage')}}" >Trang chủ</a><h3 style="display: inline-block;"></h3><span>Tất cả sản phẩm</span><h3 style="display: inline-block;"></h3><span style="color: #999;">Result for search ....</span>
            </div>
        </div>
