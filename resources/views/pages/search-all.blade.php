...
<main id="main-products">
        <div class="path-page-wrapper">
            <div class="path-page">
                <a href="{{route('homepage')}}" >Trang chủ</a><h3 style="display: inline-block;"></h3><span><a href="{{route('products')}}">Tất cả sản phẩm</a></span><h3 style="display: inline-block;"></h3><span style="color: #999;">@if(count($products)>0)Có {{count($products)}} kết quả phù hợp với từ khóa "{{$keySearch}}" .... @else Kết quả tìm kiếm với "{{$keySearch}}" .... @endif</span>
            </div>
        </div>
        ...
        <section class="products-list">
               ...
               <div class="products-show">
                  @if(count($products)==0)
                    <span style="color: orange;font-weight: bold; margin-left: 405px;">Không tìm thấy bất kỳ kết quả nào với từ khóa trên.</span>
                  @else
