...
<main id="main-products">
        <div class="path-page-wrapper">
            <div class="path-page">
                <a href="{{route('homepage')}}" >Trang chủ</a><h3 style="display: inline-block;"></h3><span>Tất cả sản phẩm</span><h3 style="display: inline-block;"></h3><span style="color: #999;">{{$end_path}}</span>
            </div>
        </div>
        ...
        <section class="products-list">
                  <div class="products-catogory">
                      ...
                      <div class="products-catogory-Search">
                          <form method="get" action="{{route('hot-new-sale',0)}}">
               ...
               <div class="products-show">
               		@if(count($products)==0)
               			<span style="color: orange;font-weight: bold; margin-left: 475px;">Không tìm thấy sản phẩm này ...</span>
               		@else
